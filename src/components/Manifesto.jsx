    ...
    <section className="manifesto">
      <div className="wrap">
        <Reveal>
          ...
          <p className="lead">We built MassageNowNow because good therapy shouldn't require a week's notice or a trip across town. Every masseuse on our platform is trained, background-checked, and rated by real clients — so relief is always one tap away.</p>
          <div className="stat-row">
            <div className="stat"><b>500+</b><span>Verified Masseuses</span></div>
